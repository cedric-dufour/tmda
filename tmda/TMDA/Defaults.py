...
#
# Default is None
if 'DB_PENDING_BLACKLIST_APPEND' not in vars():
...
#
# Default is None
if 'DB_PENDING_DELETE_APPEND' not in vars():
...
#
# Default is None
if 'DB_PENDING_RELEASE_APPEND' not in vars():
...
#
# Default is None
if 'DB_PENDING_WHITELIST_APPEND' not in vars():
